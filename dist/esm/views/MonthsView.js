...
var MonthsView = /*#__PURE__*/function (_React$Component) {
  _inherits(MonthsView, _React$Component);
  ...
  function MonthsView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_updateSelectedMonth", function (event) {
  ...
  _createClass(MonthsView, [{
    ...
    value: function renderNavigation() {
      ...
      return /*#__PURE__*/React.createElement(ViewNavigation, {
        onClickPrev: function onClickPrev() {
          return _this2.props.navigate(-1, 'years');
        },
    ...
    value: function renderMonths() {
      ...
      return rows.map(function (months, i) {
